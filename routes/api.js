...
// Superhero.find() grabs all superheros from the Mongo collection, which we 
// assign to the variable superheros. We can now use that variable in the Swig template.
